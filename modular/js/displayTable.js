...
{
    tHead = document.querySelector(".tableHead");
    tHead.innerHTML = ``;
    tableHead.forEach(th => 
    {
        if (!th.hide)
        {
            ...
            <th>
            ${th.columnName}
            <span class="rmv-col" data-id="${th.id}">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path fill="#643d8c" d="M160 144C151.2 144 144 151.2 144 160L144 480C144 488.8 151.2 496 160 496L480 496C488.8 496 496 488.8 496 480L496 160C496 151.2 488.8 144 480 144L160 144zM96 160C96 124.7 124.7 96 160 96L480 96C515.3 96 544 124.7 544 160L544 480C544 515.3 515.3 544 480 544L160 544C124.7 544 96 515.3 96 480L96 160zM232 296L408 296C421.3 296 432 306.7 432 320C432 333.3 421.3 344 408 344L232 344C218.7 344 208 333.3 208 320C208 306.7 218.7 296 232 296z"/></svg>
            </span>
            </th>
            `;
        }
    ...
    document.querySelectorAll(".rmv-col").forEach((rm) => 
    {
        rm.addEventListener("click", (event) => 
        {
            const colId = event.currentTarget.dataset.id;
            const col = tableHead.find(th => th.id === colId);
            if (col)
            {
                col.hide = true;
                displaytableHead();
...
async function listTickets(filteredData)
{
    displayedCounter = 0;
    ...
    for (displayedCounter; displayedCounter < ticketData.length; displayedCounter ++)
    {
        ...
        row.id = `row${ticketData[displayedCounter].ticket_id}`;
        rowHtml = ``;
            ...
            `
                ...
                <form id="edit-ticket-form" enctype="multipart/form-data">
                    <div>
                        ...
                        <input class="inp-val" type="text" name="full_name" id="full_name_edit" value="${row.full_name}" required />
                        <div class="input-err-msg">
                            Full Name Required !!!
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path fill="#ff3b30" d="M320 64C334.7 64 348.2 72.1 355.2 85L571.2 485C577.9 497.4 577.6 512.4 570.4 524.5C563.2 536.6 550.1 544 536 544L104 544C89.9 544 76.9 536.6 69.6 524.5C62.3 512.4 62.1 497.4 68.8 485L284.8 85C291.8 72.1 305.3 64 320 64zM320 232C306.7 232 296 242.7 296 256L296 368C296 381.3 306.7 392 320 392C333.3 392 344 381.3 344 368L344 256C344 242.7 333.3 232 320 232zM346.7 448C347.3 438.1 342.4 428.7 333.9 423.5C325.4 418.4 314.7 418.4 306.2 423.5C297.7 428.7 292.8 438.1 293.4 448C292.8 457.9 297.7 467.3 306.2 472.5C314.7 477.6 325.4 477.6 333.9 472.5C342.4 467.3 347.3 457.9 346.7 448z"/></svg>
                        </div>
                    </div>

                    <div>
                        <label for="email_address">Email Address:</label>
                        <input class="inp-val" type="email" name="email_address" id="email_address" value="${row.email_address}" required />
                        <div class="input-err-msg">
                    ...
                    <div>
                        ...
                        <input class="inp-val" type="tel" name="phone_number" id="phone_number" value="${row.phone_number}" required />
                        <div class="input-err-msg">
                    ...
                    <div>
                        ...
                        <select class="inp-val" name="subject" id="subject" required>
                    ...
                    <div>
                        ...
                        <textarea class="inp-val" name="message" id="message" required>${row.message}</textarea>
                        <div class="input-err-msg">
                            Message Required !!!
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path fill="#ff3b30" d="M320 64C334.7 64 348.2 72.1 355.2 85L571.2 485C577.9 497.4 577.6 512.4 570.4 524.5C563.2 536.6 550.1 544 536 544L104 544C89.9 544 76.9 536.6 69.6 524.5C62.3 512.4 62.1 497.4 68.8 485L284.8 85C291.8 72.1 305.3 64 320 64zM320 232C306.7 232 296 242.7 296 256L296 368C296 381.3 306.7 392 320 392C333.3 392 344 381.3 344 368L344 256C344 242.7 333.3 232 320 232zM346.7 448C347.3 438.1 342.4 428.7 333.9 423.5C325.4 418.4 314.7 418.4 306.2 423.5C297.7 428.7 292.8 438.1 293.4 448C292.8 457.9 297.7 467.3 306.2 472.5C314.7 477.6 325.4 477.6 333.9 472.5C342.4 467.3 347.3 457.9 346.7 448z"/></svg>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="pref-radio-cont">
                            <input class="inp-val" type="radio" name="contact_method" id="contact_method_email" value="email" ${row.contact_method === "email" ? "checked" : ""} required />
                            <p>Email</p>

                            <input class="inp-val" type="radio" name="contact_method" id="contact_method_phone" value="phone" ${row.contact_method === "phone" ? "checked" : ""} required />
                            <p>Phone</p>
                        </div>
                        <div class="input-err-msg">
                    ...
                    <div class="attachment-container">
                        ...
                        <input class="inp-val" type="file" name="file_attachment" id="file_attachment" accept=".pdf, .jpeg, .jpg, .png" multiple required />
                        <small>
                            Selected files:
                    ...
                    <div class="terms-container">
                        <input class="inp-val" type="checkbox" name="terms_conditions" id="terms_conditions" checked required />
