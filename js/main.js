...
async function listTickets(filteredData)
{
    ...
    // const hasFilters = document.querySelector(".filter-rows .filter-entries") !== null;
    // const hasSorts   = document.querySelector(".sort-rows .filter-entries") !== null;
    ...
    // if (hasSorts) {
    //     ticketData = applySorts(ticketData);
    // }
            ...
            `
                ...
                <form id="edit-ticket-form" enctype="multipart/form-data">
                    ...
                    <div class="attachment-container">
                        ...
                        <input type="file" name="file_attachment" id="file_attachment" accept=".pdf, .jpeg, .jpg, .png" multiple>
                        <small>
                            Selected files:
